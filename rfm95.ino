...
//long latitude = dht.readHumidity();
//long longitude = dht.readTemperature();

//
//long latitude = 7232123;
//long longitude = 110375386;
//
//byte payload[8];
//payload[0] = (byte) ((latitude & 0xFF000000) >> 24 );
//payload[1] = (byte) ((latitude & 0x00FF0000) >> 16 );
//payload[2] = (byte) ((latitude & 0x0000FF00) >> 8  );
//payload[3] = (byte) ((latitude & 0X000000FF)       );
//
//payload[4] = (byte) ((longitude & 0xFF000000) >> 24 );
//payload[5] = (byte) ((longitude & 0x00FF0000) >> 16 );
//payload[6] = (byte) ((longitude & 0x0000FF00) >> 8  );
//payload[7] = (byte) ((longitude & 0X000000FF)       );
//
